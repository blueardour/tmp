...
#    MODEL.QUANTIZATION.policy configs/FCOS-Detection/policy-fcos-r50-fixpoint.txt MODEL.RESNETS.NORM BN MODEL.FPN.NORM BN-ReLU \
#    MODEL.WEIGHTS output/fcos/R_50_1x-FPN_SyncBN-FixFPN-lsq-M2F8L8-RD2/model_0064999.pth
